...
<body>
    <h1>Doğu Akdeniz Üniversitesi Yurt Yönetim Sistemi Değerlendirme Ve Geri Bildirim Anketi</h1>
        <h2><a href="ana_sayfa.php">Anasayfaya Dön</a></h2>
        <h2>Derecelendirme ve Yorumlar</h2>
    ...
    <form action="" method="POST">
        <div class="question">
            <h3>Web Sitemizin Arayüzünü Beğendiniz mi?</h3>
            <div class="rating">
