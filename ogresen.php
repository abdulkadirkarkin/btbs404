...
<body>
    <div class="header">
        <div class="user-info">
		 <a href="ana_sayfaen.php">Home Page </a>
    ...
    <div class="modal">
        <div class="modal-content">
            <h2>Choose Your Roommate</h2>

            <form method="POST" action="ogresen.php">
              <label for="yurtadi">Dormitory Name</label>
                ...
                <button type="submit">İnquire</button>
          </form>
            <div class="status-buttons"></div>
            <h3>Male Block Floor Plans</h3>
    ...
    <div id="studentModal" class="student-modal">
        <div class="student-modal-content">
            ...
            <h2>Room Number: <span id="odaNo"></span></h2>
            <div id="studentList">
            </div>
            <form id="messageForm">
