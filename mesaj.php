...
<body>
    ...
    <div class="tabs">
        <button class="tablink" onclick="openTab(event, 'Mesajlarim')">Mesajlarım</button>
        <button class="tablink" onclick="openTab(event, 'anasayfa')"><a href="ana_sayfa.php">Anasayfa</a></button>
    </div>
